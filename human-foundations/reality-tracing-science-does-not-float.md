---
title: Science Does Not Float
subtitle: Scientific Knowledge as Living Friction-Accounting, Stored Derivation, and Cross-Axis Correction
artifact_type: Foundational Epistemic Clarification
section: Foundational Epistemics / Science, Knowledge, and Reality Tracing
...
related:
  ...
  - Ritonavir, Disappearing Polymorphs, and Living in a Form II World
  - Combinatorial Interactional Epistemics (CIE)
...
1. Scientific knowledge is not a self-subsisting object. It is maintained through living practices.

2. Scientific claims gain rank by surviving disciplined friction against reality across observers, instruments, methods, tests, and time.

3. Science does not avoid friction. It deliberately generates friction and preserves what survives.

4. Not all valid knowledge has a currently live derivation path. Some knowledge is stored, tacit, inherited, or partially severed from its original derivation.

5. Expert fields run deep domain-specific friction along a vertical axis.

6. The framework extends friction-accounting horizontally across domains, where interacting phenomena cross field boundaries.

7. Science can become priest-like to outsiders when conclusions detach from visible derivation paths.

8. The cure is not making everyone an expert, but preserving pedagogical traceability, citizen-side inspection, and correction pathways.

9. Scientific authority earns epistemic weight, but not automatic political sovereignty.

10. Governance must translate science through Core 1 accountability, local-end burden, salience, biology, material constraints, and floor effects.

11. A scientific abstraction may be answer-generative for a bounded Y-axis question while remaining too coarse to generate a unique X-axis policy.
...
This can also be stated in abstraction terms.

A scientific model may have strong **answer-generative adequacy** for the scientific task it was built to solve.

That does not automatically give it answer-generative adequacy for a broader governance task whose outcome depends on variables outside the scientific slice.

A concise formulation:

> Strong generative adequacy inside the scientific slice does not automatically survive translation into the wider lived system.
...
One useful test is substitution.

Ask:

> Can two real situations satisfy the same scientific conclusion while requiring materially different policies because their burdens, capacities, infrastructures, local ends, rates, or externalities differ?

If yes, then the scientific conclusion cannot by itself author the policy.

The science remains valid.

Its generative jurisdiction has been exceeded.

A concise formulation:

> If the same scientific result can sit above different legitimate policy responses, the scientific result is not the policy generator.
...
Once translation enters policy, local specification must be earned from the wider trace.

This includes variables such as:

- who bears the burden
- what rate of change can be absorbed
- what infrastructure exists
- what alternatives are available
- what externalities appear
- what would require revision
- what retraction path exists

A concise formulation:

> Scientific result + local trace → policy specification.

Not:

> scientific result → policy specification.
...
## 9. Substitution Clamp

Can two cases compatible with the same scientific conclusion require materially different policy responses?

If yes, what local distinctions must remain visible before a policy is specified?

## 10. Specification Clamp

Which parts of the policy are actually generated by the scientific result, and which require additional local tracing?

What threshold, rate, scope, duration, or burden allocation has been locally earned rather than merely inherited from the authority of the science?

A concise formulation:

> Applied science becomes legitimate policy only after the scientific claim, translation choice, burden distribution, local specification, and retraction path are all made inspectable.
...
- if a scientific conclusion is true, one policy therefore follows uniquely
...
> A scientific abstraction can be answer-generative within its declared slice while remaining only inquiry-generative for the wider governance problem.
...
A scientific abstraction may be highly generative for the question it was built to answer while remaining too coarse to generate a unique policy once the problem is resliced across burden, capacity, infrastructure, salience, local ends, and externalities.

If different local cases compatible with the same scientific result require different responses, return to the trace.
